...
<div class="row">
<div class="col-lg-6">
<span class="logo">PK Skill's</span></div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Computer science and bussiness system</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7904653984</h4>
		<h4 style="font-family:'typo' ">praveengovind2.0@gmail.com</h4>
		<h4 style="font-family:'typo' ">KSR College Of Technology</h4></div></div>
		</p>
      </div>
