...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your Roll no (Ex.7377202****)" class="form-control input-md" type="text" value="<?php
...
?>>Electronics and Communication Engineering</option>
  <option value="CSBS" <?php
  if (isset($_GET['branch']))
  {
if ($_GET['branch'] == "CSBS")
    echo "selected";
  }
?>>Computer science and business system</option>
...
<div class="col-md-3 box">
<span href="#"data-target="#login" style="color:lightyellow">Organized by Praveen kumar</span>
</div>
